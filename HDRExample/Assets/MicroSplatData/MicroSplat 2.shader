...
Shader "Terrain"
{
   ...
   SubShader
   {
            Tags {"RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "24"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_Base1650103375"
   Fallback "Hidden/Terrain_Base1650103375"
